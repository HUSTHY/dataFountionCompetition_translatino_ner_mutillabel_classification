...
class BertCrfForNer(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None,labels=None,input_lens=None):
        ...
        for i, dropout in enumerate(self.dropouts):
            if i == 0:
                h = self.classifier(dropout(sequence_output))
            else:
                hi = self.classifier(dropout(sequence_output))
                h = h + hi
...
class BertSpanForNer(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, start_positions=None,end_positions=None):
        ...
        # for i, dropout in enumerate(self.dropouts):
        #     if i == 0:
        #         h = self.start_fc(dropout(sequence_output))
        #     else:
        #         hi = self.start_fc(dropout(sequence_output))
        #         h = h + hi
        # start_logits = h / len(self.dropouts)
        ...
        # for i, dropout in enumerate(self.dropouts):
        #     if i == 0:
        #         h = self.end_fc(dropout(sequence_output), label_logits)
        #     else:
        #         hi = self.end_fc(dropout(sequence_output), label_logits)
        #         h = h + hi
        # end_logits = h / len(self.dropouts)
