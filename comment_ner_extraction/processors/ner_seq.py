...
def convert_examples_to_features(examples,label_list,max_seq_length,tokenizer,
    ...
    logger.info("label_map:{}",label_map)
    features = []
...
class CnerProcessor(DataProcessor):
    ...
    def get_train_examples(self, path):
        """See base class."""
        return self._create_examples(self._read_text(path), "train")

    def get_dev_examples(self, path):
        """See base class."""
        return self._create_examples(self._read_text(path), "dev")

    def get_test_examples(self, path):
        """See base class."""
        return self._create_examples(self._read_text(path), "test")

    def get_labels(self):
        """See base class."""
        return ["X",'I-PRODUCT', 'B-PRODUCT', 'I-BANK', 'I-COMMENTS_ADJ', 'O', 'B-BANK', 'I-COMMENTS_N', 'B-COMMENTS_ADJ', 'B-COMMENTS_N','[CLS]','[SEP]']
