...
log_file = 'log_files/'+'v0_MLCE_L512_rdrop0_bert.log'
...
def train(args):
    ...
    save_path = os.path.join(args.model_out, args.loss_function_type,"BertMutilLalelClassification_rdrop_0" + time_srt)
